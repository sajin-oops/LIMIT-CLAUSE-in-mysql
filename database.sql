...
mysql> select*from employees where salary BETWEEN 1070 AND 10000;
+-------+---------+----------------+--------+
| empid | empname | jobdescription | salary |
+-------+---------+----------------+--------+
| 7     | sea     | front-end      |  10000 |
...
mysql>  select*from employees where jobdescription not in("data analyst","data scientist")LIMIT 3;
+-------+---------+------------------------+---------+
| empid | empname | jobdescription         | salary  |
+-------+---------+------------------------+---------+
| 4     | sam     | data engineer          | 3000000 |
